// $Id: CalamariPlugin.java,v 1.2 2003/10/20 22:35:57 mikedemmer Exp $
...
/*                      try {
 ...
 //                       tv.setStatus("Setting Value for mote " + mote.getID() + " on ADC channel " + channel + " to " + value.toString());
                ...
                MoteCoordinateAttribute txrCoord = txr.getCoordinate(), rxrCoord = rxr.getCoordinate();
                ...
                try {
                    ...
                    if(distance>MAX_RANGE)
                        ...
                        rssi = new Integer(distance + (int)(NOISE_LEVEL*(Math.random()*2-1)));
...
//                    tv.setStatus("Setting RSSI for mote " + rxr.getID() + " to (" + rssi + ")" + "for msg from " + txr.getID());
    ...
    public void draw(Graphics graphics) {
        Enumeration enum = locationEstimates.elements();
        while (enum.hasMoreElements()) {
            LocationEstimate loc = (LocationEstimate) enum.nextElement();
