// $Id: MonibusToUSBM.nc,v 1.2 2005/03/18 19:27:45 neturner Exp $
...
implementation {
  ...
  ////////////////  StdControl commands  ////////////////
  /**
   * Call init() on the MonibusHPLUART, Leds, MessageControl, and TimerControl
   * components.
   * <p>
  ...
  /**
   * Call stop() on the MonibusHPLUART, MessageControl, and Timer components.
   * <p>
   * @return Always return SUCCESS.
   */
  ...
  ////////////////  Timer events  ////////////////
  /**
   * Send <code>SPACE</code> to the MonibusHPLUART component.
  ...
  event result_t Timer.fired() {
    ...
    atomic {
      if (ableToSendByte) {
	call MonibusHPLUART.put(SPACE);
	//call MonibusHPLUART.put(0xfe);
  ...
  async event result_t MonibusHPLUART.putDone() {
    ...
    //call MonibusHPLUART.disableUARTTransmitPin();
    atomic {
      ableToSendByte = TRUE;
    }
    return SUCCESS;
