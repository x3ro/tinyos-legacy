function output = exp_collect_data(varargin)
...
app_params.data_clock_interval = 10*100000;
...
phase_shift(id) = 0;
ws('insert_event', 'exp_collect_data', 'clock_tick', start_time, id, {});
void = -1;
...
ws('insert_event', 'exp_collect_data', 'clock_tick', interval + phase_shift(id), id, {});
if (phase_shift(id) ~= 0)
    phase_shift(id) = 0;
end
void = -1;
...
if right_parent & valid_parent & not_bs & ~cycle & all_mote.parent(id) ~= protocol_params.invalid_parent %& id ~= sim_params.base_station
