...
#define STABLE_TIME 7
#define SAMP_PER_SECOND 32
//#define MAG_EVENT_DETECT_SEND_RATE 7, 0x5
#define MAG_EVENT_DETECT_SEND_RATE 7, 0x3


//parameters for the slow filter
//#define OFF_RANGE_MAX 3200
//#define AVG_UPDATE_RATE 100 

//parameters for the fast filter
...
void TOS_COMMAND(SET_DEBUG)(char val){VAR(debug) = val;}
