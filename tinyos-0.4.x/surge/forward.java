...
private static final String  CLASS_NAME                  = "forward";
...
public forward(String portName) {
...
public static void main(String args[]) {
  if (args.length != 1) {
    System.err.println("usage: java forward [port]");
    System.exit(-1);
  }

  System.out.println("\nforward started");
  forward reader = new forward(args[0]);
  try {
