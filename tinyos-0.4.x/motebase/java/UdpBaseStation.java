...
public class UdpBaseStation implements PacketListenerIF {

  //===========================================================================
  //===   CONSTANTS   =========================================================
  
private static final String  CLASS_NAME                  = "UdpBaseStation";
private static final String  VERSION     	         = "v0.1";

private static final int payloadOffset =  2;
private static final int payloadLength = 20;
...
public UdpBaseStation(String serialPortName, InetAddress host, int port) {
...
private static void printUsageAndExit() {
  System.err.println("usage: java UdpBaseStation <serial_port> <host> <port>"); 
  System.exit(-1);
}
...
public static void main(String args[]) {
  ...
  System.out.println("\nUdpBaseStation started");
  try {
    UdpBaseStation bs = new UdpBaseStation(args[0], InetAddress.getByName(args[1]), Integer.parseInt(args[2]));
    bs.start();
  }
  catch (Exception e) {
    e.printStackTrace();
