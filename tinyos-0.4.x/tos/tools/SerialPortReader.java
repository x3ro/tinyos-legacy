...
public class SerialPortReader {
    ...
    public static final byte UART_START_SYMBOL = 1;
    //=   CONSTANTS   =========================================================
    //===========================================================================
    ...
    public static int MSG_LENGTH = 38;
  ...
  //	port.setFlowControlMode(SerialPort.FLOWCONTROL_RTSCTS_OUT);
	...
	if (args.length != 1) {
	    System.err.println("usage: java SerialPortReader [port]");
	    System.exit(-1);
	}

	System.out.println("\nSerialPortReader started");
	SerialPortReader reader = new SerialPortReader(args[0]);
	try {
