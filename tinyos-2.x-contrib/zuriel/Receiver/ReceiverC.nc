...
/**
 *
 * Configuration file of the module ReceiverP.nc
 *
...
implementation
{
	...
	components ReceiverP as App;

	components CC2420ControlC;
	components CC2420PacketC;

	components ActiveMessageC;
	components new AMReceiverC(AM_MOTE_CTRL_MSG) as AMReceiverMoteCtrl;
	...
	App.AMReceiverMoteCtrl    -> AMReceiverMoteCtrl;
}
