...
public class SerialPortStub implements SerialStub{
    ...
    private static final int MSG_SIZE = 36;
  ...
  //	port.setFlowControlMode(SerialPort.FLOWCONTROL_RTSCTS_OUT);
	...
	if (args.length != 1) {
	    System.err.println("usage: java SerialPortStub [port]");
	    System.exit(-1);
	}

	System.out.println("\nSerialPortStub started");
	SerialPortStub reader = new SerialPortStub(args[0]);
	try {
