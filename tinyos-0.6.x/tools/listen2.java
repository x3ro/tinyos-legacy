...
private static final String  VERSION     	         = "v0.1";
    private static final int MSG_SIZE = 40;  // 3 header bytes, 31 msg bytes, 2 crc bytes
private static final int MSG_LEN_INDEX = 6;  
  //===   CONSTANTS   =========================================================
  //===========================================================================
...
public listen2(String portName) {
...
public void read() throws IOException {
  ...
  while ((i = in.read()) != -1) {
	...
	if (val.length() == 1) {
    	...
    	//System.out.print(i + " ");
	if (count == MSG_LEN_INDEX) {
		len = i; // length + hdr + crc
...
public static void main(String args[]) {
  ...
  System.out.println("\nlisten started");
  listen2 reader = new listen2(args[0]);
  try {
