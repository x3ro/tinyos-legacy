...
% xTotal=0;
% yTotal=0;
% maxDist = max(max(LOCALIZATION.distances));
% for i=1:length(LOCALIZATION.moteIDs)
%     if LOCALIZATION.distances(409,LOCALIZATION.moteIDs(i))>0
%         [X Y] = getLocation(LOCALIZATION.moteIDs(i));
%         x = x + X*(maxDist-LOCALIZATION.distances(409,LOCALIZATION.moteIDs(i)));
%         xTotal = xTotal + (maxDist-LOCALIZATION.distances(409,LOCALIZATION.moteIDs(i)));
%         y = y + Y*(maxDist-LOCALIZATION.distances(409,LOCALIZATION.moteIDs(i)));
%         yTotal = yTotal + (maxDist-LOCALIZATION.distances(409,LOCALIZATION.moteIDs(i)));
%     end
% end
% x = x/xTotal;
% y = y/yTotal;
