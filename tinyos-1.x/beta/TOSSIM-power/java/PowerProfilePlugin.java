	     ...
	     if ((index_match = msg.indexOf(match)) != -1) {
             ...
             if ((index_match = msg.indexOf(match)) != -1) {
               ...
               if((index_2 = strParsed[2].indexOf(new String("START"))) != -1) {
                  ...
                  if((index_2 = strParsed[1].indexOf(new String("WRITE"))) != -1)  { next_eeprom = EEPROM_READ; }
               }
...
//modified from ADCPlugin.java
  ...
  public void draw(Graphics graphics) {
	...
	continue;
        ...
        //strEnergy = new String("Battery:" + String.valueOf(e_remaining));
        strEnergy = new String("e_consumed:" + String.valueOf(e_total[mote.getID()]));
