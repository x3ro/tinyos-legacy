...
implementation {
  ...
  components MultiHopEngineM, MultiHopWMEWMA, GenericCommPromiscuous as Comm, 
    QueuedSend, TimerC, FunnelingMAC,
#ifdef USE_WATCHDOG
	WDTC,
#endif
	NoLeds as LedsC;
  ...
  MultiHopEngineM.SubControl -> FunnelingMAC.StdControl;
  ...
  MultiHopEngineM.SendMsg -> FunnelingMAC.SendMsg;
  MultiHopEngineM.SnoopFmac -> FunnelingMAC.SnoopFmac;

  MultiHopWMEWMA.RouteManagement -> FunnelingMAC.RouteManagement;
