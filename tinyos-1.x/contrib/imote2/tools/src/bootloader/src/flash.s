...
@ Date:		09/02/2005
@
@ Ported from the TinyOS repository. This file provides the
@ basic functions for flash access like read, write, erase etc.
@@@@@@@@@@@@@@@@@@@@@@@@@@	
