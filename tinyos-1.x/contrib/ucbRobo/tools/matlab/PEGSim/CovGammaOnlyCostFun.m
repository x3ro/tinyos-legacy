function J = CovGammaOnlyCostFun(u)
% Modified from CovGammaCostFun to test connectivity term
% J = cost(u) - trace(Cov) with weights
...
for t = 1:Pctrlr.ph
    ...
    % finding the n closest nodes to the pursuer
