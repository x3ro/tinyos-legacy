function printMagDebugMsg_MagMHopRpt(address, message, connectionName)
% Because MagDebugMsgs report very quickly, you may get a steady stream of
% reports if your threshold is set too low.  MAGMHOPRPT.rptMsgFlag is a
% flag to shut of message reports while you tune the report threshold

global APPS;
if (isfield(APPS,'MAGMHOPRPT') && APPS.MAGMHOPRPT.dbgMsgFlag)
    disp(message);
