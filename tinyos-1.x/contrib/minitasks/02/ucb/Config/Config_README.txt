...
$Id: Config_README.txt,v 1.1 2003/06/08 19:25:20 cssharp Exp $
...
ConfigC.StdControl to Main in your main application configuration.
...
interface, simplifying your wiring.
...
we do need to use and wire to the Config_mag_period interface so that we
can reset the timer.  The updated event code could look like this:
