 ...
 * bibble
 * 
 * June 5, 2003, Ver5.5.5.1_BerkeleyIntegration
 * Change the message format for Liqian, Yong and Qing
 *
 */
...
class DisplayConstants {
	public static final int NodeNumber = 9;
...
class ClientThread extends Observable implements Runnable {
  ...
  private void readServer() {
	...
	int i, j;
	/* spane.receivedNodeMsg(0, 40, 200, 0, 0, 0);
	for (i = 1; i < 10; i++) {
		for (j = 0; j < 2; j++) {
			spane.receivedNodeMsg(i + j *10, 40 + 40 * i , 200 - 40 * j, 0, 0, 0);
		}
	}*/
