...
for t=2:length(vtrack)
    ...
    if drawfigure 
        plot(50/60*([xest(1,vtrack(t-1)) xest(1,vtrack(t))]+20)',...
             50/60*([xest(2,vtrack(t-1)) xest(2,vtrack(t))]-110)','w','LineWidth',linewidth+3);
        plot(50/60*([xest(1,vtrack(t-1)) xest(1,vtrack(t))]+20)',...
             50/60*([xest(2,vtrack(t-1)) xest(2,vtrack(t))]-110)',plotdot,'LineWidth',linewidth);
        if length(mytext)>0
            if t==2
