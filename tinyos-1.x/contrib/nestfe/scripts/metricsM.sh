...
# This version of metrics.sh Starts up MetricsMotes without prompting.
...
WINMETRICSTOOL="$WINMETRICS tools MetricsMote"
WINMETRICSMON="$WINMETRICS mon MetricsMote"
WINMETRICSLAT="$WINMETRICS lat MetricsMote"
