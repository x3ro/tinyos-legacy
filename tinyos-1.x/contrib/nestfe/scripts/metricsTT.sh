...
# This version of metrics.sh starts up TestDetectionEvent with a
...
WINMETRICSTOOL="$WINMETRICS tools TestDetectionEvent tree"
WINMETRICSMON="$WINMETRICS mon TestDetectionEvent tree"
WINMETRICSLAT="$WINMETRICS lat TestDetectionEvent tree"
