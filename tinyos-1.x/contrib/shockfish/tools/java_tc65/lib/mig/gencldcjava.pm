...
# Modified genjava.pm for CLDC devices
# Pierre Metrailler, Shockfish SA
# pierre@shockfish.com
...
sub gen() {
    ...
    $java_extends = "com.shockfish.tinyos.message.CldcMessage" if !defined($java_extends);
    ...
    print " * This class implements a Java CLDC interface to the '$java_classname'\n";
    print " * message type.\n";
    print " */\n\n";
    ...
    print "     */\n";
    print "    public $java_classname(com.shockfish.tinyos.message.CldcMessage msg, int base_offset) {\n";
    ...
    print "     */\n";
    print "    public $java_classname(com.shockfish.tinyos.message.CldcMessage msg, int base_offset, int data_length) {\n";
	...
	if (!@$amax) {
	  ...
	  if ($javatype eq "float") {
	    ...
	    print "        s += \"  [$field=\"+Long.toString(get_$javafield())+\"]\\n\";\n";
	  }
	  ...
	  if ($javatype eq "float") {
	    ...
	    if ($bitlength > 32) {
	      print "          s += \"\"+Long.toString(getElement_$javafield(i))+\" \";\n";
	    }
	    elsif (bitlength > 16) {
	      print "          s += \"\"+Long.toString(getElement_$javafield(i) )+\" \";\n";
	    }
