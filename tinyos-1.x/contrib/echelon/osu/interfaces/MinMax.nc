...
interface MinMax {
  ...
  /* 8-bit unsigned vector */
  command void OpU8(uint8_t *data, uint16_t len, uint8_t *min, uint8_t *max);
  command result_t StartU8(uint8_t *data, uint16_t len);
  event void DoneU8(uint8_t min, uint8_t max);

  /* 16-bit signed vector */
  command void Op16(int16_t *data, int16_t len, int16_t *min, int16_t *max);
  command result_t Start16(int16_t *data, int16_t len);
  event void Done16(int16_t min, int16_t max);
} // MinMax
