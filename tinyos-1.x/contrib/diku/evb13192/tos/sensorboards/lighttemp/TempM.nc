/* $Id: TempM.nc,v 1.1 2005/01/31 21:05:56 freefrag Exp $ */
/* Module for using the Temp sensor
...
implementation {
  ...
  command result_t StdControl.init() {
    ...
    TOSH_TEMP_PORT_ENABLE();
    call ADCControl.bindPort(TOSH_ADC_TEMP_PORT, TOSH_ACTUAL_TEMP_PORT);
