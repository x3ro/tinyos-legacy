...
**************************************************************/
#ifndef _MCUTORADIOPORTS_H_
#define _MCUTORADIOPORTS_H_
	...
	#define MC13192_ANT_CTRL          
	#define MC13192_ANT_CTRL_PORT     
	
	// MC13192 LNA pin
	#define MC13192_LNA_CTRL          
	#define MC13192_LNA_CTRL_PORT     
...
**************************************************************/
	...
	#define SETUP_ANT_CTRL_PORT       
	#define SETUP_LNA_CTRL_PORT       
	...
	#define ENABLE_RX_ANTENNA         
	#define ENABLE_TX_ANTENNA         
	#define ENABLE_LNA_CTRL           
	#define DISABLE_LNA_CTRL          
	...
	#define IRQ_FLAG_SET              (MC13192_IRQ_FLAG_BIT == 1)
#endif
