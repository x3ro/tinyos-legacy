 ...
 * This class implements a Java interface to the 'BVRCommandResponseMessage'
 * message type.
 */

package net.tinyos.bvr.messages;

public class BVRCommandResponseMessage extends net.tinyos.message.Message {
    ...
    /** Create a new BVRCommandResponseMessage of size 28. */
    public BVRCommandResponseMessage() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new BVRCommandResponseMessage of the given data_length. */
    public BVRCommandResponseMessage(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BVRCommandResponseMessage with the given data_length
     * and base offset.
     */
    public BVRCommandResponseMessage(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BVRCommandResponseMessage using the given byte array
     * as backing store.
     */
    public BVRCommandResponseMessage(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public BVRCommandResponseMessage(byte[] data, int base_offset) {
     ...
     */
    public BVRCommandResponseMessage(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BVRCommandResponseMessage embedded in the given message
     * at the given base offset.
     */
    public BVRCommandResponseMessage(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public BVRCommandResponseMessage(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <BVRCommandResponseMessage> \n";
      try {
