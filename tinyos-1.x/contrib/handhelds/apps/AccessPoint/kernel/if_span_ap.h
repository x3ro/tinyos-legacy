/*
 *	This file declares the constants and data structures used by the SpanAP
 *      access point driver.
 *
 *      Andrew Christian
 *      February 2005
...
#ifndef __LINUX_SPAN_AP_H
#define __LINUX_SPAN_AP_H

#define ARPHRD_SPAN_AP	519		/* Dummy type for ARP header */
...
// This data structure is sent for all types of events from the Span client
