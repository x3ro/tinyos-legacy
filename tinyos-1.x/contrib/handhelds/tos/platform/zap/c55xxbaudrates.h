//$Id: c55xxbaudrates.h,v 1.1 2005/07/29 18:29:30 adchristian Exp $
//@author Vlado Handziski <handzisk@tkn.tu-berlin.de>

#ifndef _H_c55xxbaudrates_h
#define _H_c55xxbaudrates_h
...
# msp-uart.pl -- calculates the uart registers for C55XX
#
