BEGIN		pushn det  // Check whether a detector is already here
...
BARRIER_LOOP	getvar 9
		...
		jumps
BARRIER_DONE	rand  
		pushc 63 // 63=111111b31 //31=11111b //15 // 15=1111b
		land     
		pushc 20
		add
