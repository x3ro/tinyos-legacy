// $Id: TupleSpace.h,v 1.8 2006/05/18 19:58:41 chien-liang Exp $
...
typedef struct AgillaTuple {
  uint8_t flags;   // whether the tuple exists & is a system tuple
...
typedef struct AgillaTSGResMsg {
  uint16_t addr;  // the address of the mote with the matching tuple
