// $Id: CodeMgrM.nc,v 1.7 2006/05/18 19:58:40 chien-liang Exp $
...
implementation 
{
   ...
   */  
  command result_t CodeMgrI.allocateBlocks(AgillaAgentContext* context, uint16_t codeSize) 
  {
    int16_t i, numBlocks;
   ...
   */    
  command result_t CodeMgrI.setBlock(AgillaAgentContext* context, AgillaCodeMsg* cMsg) {    
    int16_t i, cBlock;    
   ...
   */
  command result_t CodeMgrI.deallocateBlocks(AgillaAgentContext* context) {
   ...
   */  
  command result_t CodeMgrI.fillCodeMsg(AgillaAgentContext* context, AgillaCodeMsg* msg, 
    int16_t blockNum) 
  {        
   ...
   */  
  /*command result_t CodeMgrI.transferCode(AgillaAgentContext* fromContext, 
