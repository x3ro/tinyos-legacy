...
implementation {
  ...
  /*ReceiveStateM.MessageBufferI -> ReceiverCoordinatorM;
  ReceiveCodeM.MessageBufferI -> ReceiverCoordinatorM;
  ReceiveOpStackM.MessageBufferI -> ReceiverCoordinatorM;
  ReceiveHeapM.MessageBufferI -> ReceiverCoordinatorM;
  ReceiveRxnM.MessageBufferI -> ReceiverCoordinatorM;*/
