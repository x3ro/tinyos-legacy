// $Id: SystemTSMgrM.nc,v 1.4 2006/05/18 19:58:40 chien-liang Exp $
...
implementation {
  ...
  inline result_t doit(int op, AgillaAgentID id) {
    AgillaTuple tuple;
  ...
  command result_t SysTSMgr.outAgentTuple(AgillaAgentID aID) {
    return doit(TSMGR_OUT, aID);
  }

  command result_t SysTSMgr.inAgentTuple(AgillaAgentID aID) {    
