// $Id: TupleSpaceM.nc,v 1.13 2006/05/18 19:58:40 chien-liang Exp $
...
//
  ...
  command result_t TS.reset() {
    ...
    freeIndex = 0;  
    nmemcpy((void *)&ts[freeIndex], (void *)&tuple, tupleSize); // insert the host ID tuple
    freeIndex += tupleSize;      
    return SUCCESS;
  }
}
