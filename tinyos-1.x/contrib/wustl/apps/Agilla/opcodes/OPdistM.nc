// $Id: OPdistM.nc,v 1.5 2006/05/18 19:58:41 chien-liang Exp $
...
{  
  ...
  result_t compare2Locs(AgillaAgentContext* context, AgillaLocation* loc1, 
    AgillaLocation* loc2)
  {
  ...
  command result_t BytecodeI.execute(uint8_t instr, AgillaAgentContext* context) 
  {
    ...
    if (call OpStackI.popOperand(context, &sv1)) 
    {
      if (call OpStackI.popOperand(context, &sv2)) 
      {        
