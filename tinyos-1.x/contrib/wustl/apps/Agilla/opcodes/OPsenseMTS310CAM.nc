// $Id: OPsenseMTS310CAM.nc,v 1.3 2006/05/23 21:05:59 chien-liang Exp $
...
module OPsenseMTS310CAM {
  ...
  uses {
    ...
    interface Timer as SounderTimer;
    interface QueueI;
    interface ErrorMgrI;
  }
}
implementation {
  ...
  bool sounderOn, sounding;

  command result_t StdControl.init() {    
    call QueueI.init(&waitQueue, OP_SENSE_MTS310CA_M);    
    //call QueueI.init(&waitQueue);    
    //dbg(DBG_USR1, "OPsenseMTS310CAM queue is at address %i\n", (int)&waitQueue);
