// $Id: OPtsM.nc,v 1.8 2006/05/23 21:05:59 chien-liang Exp $
...
implementation {
  ...
  command result_t StdControl.init() {    
    call QueueI.init(&blockedQ, OP_TS_M);   
    //call QueueI.init(&blockedQ);   
    // call QueueI.init(&waitingQ);
    //dbg(DBG_USR1, "OPtsM queue is at address %i\n", (int)&blockedQ);
    return SUCCESS;
  }
