// $Id: HeapMgrI.nc,v 1.2 2006/05/18 19:58:41 chien-liang Exp $
...
interface HeapMgrI {
   ...
   */
  command result_t saveMsg(AgillaAgentContext* context, AgillaHeapMsg* heapMsg);
   ...
   */
  command result_t hasHeap(AgillaAgentContext* context);
