// $Id: TupleSpaceI.nc,v 1.4 2006/05/18 19:58:41 chien-liang Exp $
...
interface TupleSpaceI {
   ...
   * is full.
   */
  command result_t out(AgillaTuple* tuple);
   ...
   */
  command result_t hinp(AgillaTuple* template);
   ...
   */
  event result_t newTuple(AgillaTuple* tuple);
   ...
   */
  event result_t byteShift(uint16_t from, uint16_t amount);
