// $Id: AgentMgrI.nc,v 1.4 2006/05/18 19:58:41 chien-liang Exp $
...
interface AgentMgrI {
   ...
   */
  command result_t run(AgillaAgentContext* agent);
   ...
   */
  command result_t migrate(AgillaAgentContext* context, uint16_t dest, 
