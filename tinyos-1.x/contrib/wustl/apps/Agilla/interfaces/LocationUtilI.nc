// $Id: LocationUtilI.nc,v 1.3 2006/05/18 19:58:41 chien-liang Exp $
...
interface LocationUtilI {
   ...
   */
  command result_t isBcast(AgillaLocation *l);

  /**
   * Returns SUCCESS if the specified location is the UART address.
   */
  command result_t isUart(AgillaLocation *l);
  
  /**
   * Returns SUCCESS if the two locations are equal, FALSE otherwise.
   */
  command result_t equals(AgillaLocation* l1, AgillaLocation* l2);
