// $Id: OpStackI.nc,v 1.2 2006/05/18 19:58:41 chien-liang Exp $
...
interface OpStackI {
   ...
   */
  command result_t pushAgentID(AgillaAgentContext* context, AgillaAgentID* aID);
   ...
   */
  command result_t pushLocation(AgillaAgentContext* context, AgillaLocation* loc);
   ...
   */
  command result_t pushString(AgillaAgentContext* context, uint16_t string);
   ...
   * otherwise (e.g. stack overflow).
   */
  command result_t pushReading(AgillaAgentContext* context, uint16_t type, int16_t val);
   ...
   */
  command result_t pushType(AgillaAgentContext* context, uint16_t type);
   ...
   * @return SUCCESS if TYPE was placed on the stack.
   */
  command result_t pushReadingType(AgillaAgentContext* context, uint16_t rType);
   ...
   */
  command result_t pushValue(AgillaAgentContext* context, int16_t val);
   ...
   * otherwise (e.g. stack overflow).
   */
  command result_t pushOperand(AgillaAgentContext* context, AgillaVariable* var);
   ...
   */
  command result_t popOperand(AgillaAgentContext* context, AgillaVariable* var);
   ...
   * @return SUCCESS If there was an operand to pop.
   */
  command result_t peekOperand(AgillaAgentContext* context, AgillaVariable* var);
   ...
   */
  command uint8_t saveMsg(AgillaAgentContext* context, AgillaOpStackMsg* osMsg);
  
  /**
   * Resets the context's operand stack.
   */
  command result_t reset(AgillaAgentContext* context);
  
  /**
   * Prints a string representation of the Operand Stack.
   */
  command result_t toString(AgillaAgentContext* context);
}
