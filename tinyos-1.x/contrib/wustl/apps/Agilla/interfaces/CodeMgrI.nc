// $Id: CodeMgrI.nc,v 1.3 2006/05/18 19:58:41 chien-liang Exp $
...
interface CodeMgrI {
   ...
   */
  command result_t allocateBlocks(AgillaAgentContext* context, uint16_t codeSize);
   ...
   */ 
  command result_t setBlock(AgillaAgentContext* context, 
    AgillaCodeMsg* cMsg);
   ...
   */
  command result_t deallocateBlocks(AgillaAgentContext* context);
   ...
   */
  command result_t fillCodeMsg(AgillaAgentContext* context, 
    AgillaCodeMsg* msg, int16_t blockNum);
   ...
   */
  /*command result_t transferCode(AgillaAgentContext* fromContext, 
