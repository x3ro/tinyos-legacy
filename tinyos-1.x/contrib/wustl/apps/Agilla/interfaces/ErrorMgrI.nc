// $Id: ErrorMgrI.nc,v 1.3 2006/05/18 19:58:41 chien-liang Exp $
...
interface ErrorMgrI {  
   ...
   */
  command result_t error(AgillaAgentContext* context, uint8_t cause);
   ...
   */
  command result_t errord(AgillaAgentContext* context, uint8_t cause, 
    uint16_t data1);
   ...
   */
  command result_t error2d(AgillaAgentContext* context, uint8_t cause, 
