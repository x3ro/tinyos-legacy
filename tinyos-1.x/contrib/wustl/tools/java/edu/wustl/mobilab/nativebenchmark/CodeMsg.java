 ...
 * This class implements a Java interface to the 'CodeMsg'
 * message type.
 */

package edu.wustl.mobilab.nativebenchmark;

public class CodeMsg extends net.tinyos.message.Message implements java.io.Serializable {
    ...
    /** Create a new CodeMsg of size 20. */
    public CodeMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new CodeMsg of the given data_length. */
    public CodeMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new CodeMsg with the given data_length
     * and base offset.
     */
    public CodeMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new CodeMsg using the given byte array
     * as backing store.
     */
    public CodeMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public CodeMsg(byte[] data, int base_offset) {
     ...
     */
    public CodeMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new CodeMsg embedded in the given message
     * at the given base offset.
     */
    public CodeMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public CodeMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
