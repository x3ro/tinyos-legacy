 ...
 * This class implements a Java interface to the 'StateMsg'
 * message type.
 */

package edu.wustl.mobilab.nativebenchmark;

public class StateMsg extends net.tinyos.message.Message implements java.io.Serializable {
    ...
    /** Create a new StateMsg of size 16. */
    public StateMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new StateMsg of the given data_length. */
    public StateMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new StateMsg with the given data_length
     * and base offset.
     */
    public StateMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new StateMsg using the given byte array
     * as backing store.
     */
    public StateMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public StateMsg(byte[] data, int base_offset) {
     ...
     */
    public StateMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new StateMsg embedded in the given message
     * at the given base offset.
     */
    public StateMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public StateMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
