// $Id: AgillaAssembler.java,v 1.14 2006/05/25 02:33:26 chien-liang Exp $
...
import java.util.*;
import edu.wustl.mobilab.agilla.messages.AgillaCodeMsg;
 ...
 *  * @author Phil Levis <pal@cs.berkeley.edu> * @author Chien-Liang Fok <liangfok@wustl.edu> */public class AgillaAssembler implements AgillaConstants {
	...
	private static final String[] opcodeClasses = new String[] {
		"edu.wustl.mobilab.agilla.opcodes.BasicOpcodes",
		"edu.wustl.mobilab.agilla.opcodes.ExtendedOpcodes1",
		"edu.wustl.mobilab.agilla.opcodes.ExtendedOpcodes2",
		"edu.wustl.mobilab.agilla.opcodes.ExtendedOpcodes3",
		"edu.wustl.mobilab.agilla.opcodes.ExtendedOpcodes4",
		"edu.wustl.mobilab.agilla.opcodes.ExtendedOpcodes5",
		"edu.wustl.mobilab.agilla.opcodes.ExtendedOpcodes6",
		"edu.wustl.mobilab.agilla.opcodes.ExtendedOpcodes7",
		"edu.wustl.mobilab.agilla.opcodes.ExtendedOpcodes8",
		"edu.wustl.mobilab.agilla.opcodes.ExtendedOpcodes9",
		"edu.wustl.mobilab.agilla.opcodes.ExtendedOpcodes10",
		"edu.wustl.mobilab.agilla.opcodes.ExtendedOpcodes11",
		"edu.wustl.mobilab.agilla.opcodes.ExtendedOpcodes12",
		"edu.wustl.mobilab.agilla.opcodes.ExtendedOpcodes13"		
	};
