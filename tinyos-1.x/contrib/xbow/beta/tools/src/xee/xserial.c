 ...
 * 
 * $Id: xserial.c,v 1.4 2004/12/08 01:55:19 husq Exp $
 */
...
static unsigned    g_verbose  = 0;       // verbose flag
...
//    fcntl(serline, F_SETFL, O_NONBLOCK);
...
/** Writes one XbowParamConfigPacket to the serial port. */
int xserial_port_write_packet(int serline, unsigned char *buffer, int cnt) 
{
