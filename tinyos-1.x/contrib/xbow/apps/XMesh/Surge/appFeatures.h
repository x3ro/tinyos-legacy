 ...
 *
 * $Id: appFeatures.h,v 1.2 2005/01/22 01:51:42 mturon Exp $
 */
...
/// FEATURE_TRACK_POWER -- sends estimate of amp hours used
#ifndef FEATURE_TRACK_POWER
#define FEATURE_TRACK_POWER 0
#endif
...
#define XSENSOR_SAMPLE_RATE  (4096 - (TOS_LOCAL_ADDRESS))
#else
...
/** FEATURE_TRACK_POWER will enable over-the-air programming when set to 1. */
#if FEATURE_TRACK_POWER
#define TRACK_POWER_COMPONENT       CC1000RadioIntM,
#else
#define TRACK_POWER_COMPONENT
#endif
