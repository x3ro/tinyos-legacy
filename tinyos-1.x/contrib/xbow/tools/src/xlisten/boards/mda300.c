...
const char *mda300_db_create_table[6] = 
    ...
    "CREATE TABLE %s%s ( result_time timestamp without time zone, "
    "nodeid integer, parent integer, "
    "adc0 integer, adc1 integer, adc2 integer, "
...
void mda300_log_raw(XbowSensorboardPacket *packet) 
{
    ...
    tablename[0]="mda300p1_results";
    tablename[1]="mda300p2_results";
    tablename[2]="mda300p3_results";
    tablename[3]="mda300p4_results";
    tablename[4]="mda300p5_results";
    tablename[5]="mda300p6_results";
