// $Id: MSP430ArbiterUSART1C.nc,v 1.1.1.1 2007/11/05 19:11:33 jpolastre Exp $
/*
 ...
 */
configuration MSP430ArbiterUSART1C
{
...
implementation
{
  ...
  components new FcfsArbiterC( uniqueCount("MSP430ResourceUSART1")+1 ) as ArbiterC;
  components MSP430ResourceConfigUSART1C as ConfigC;
