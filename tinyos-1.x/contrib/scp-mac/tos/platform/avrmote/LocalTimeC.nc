...
implementation
{
  components LocalTimeM, CounterAsyncC;
  
  TimeControl = LocalTimeM;
  LocalTime = LocalTimeM;
  TestSigOverflow = LocalTimeM;
  
  // wiring to lower layers
  
  LocalTimeM.CntrControl -> CounterAsyncC.StdControl;
  LocalTimeM.CntrValue -> CounterAsyncC;
  LocalTimeM.CntrOverInt -> CounterAsyncC;
}
