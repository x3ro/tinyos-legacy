...
public class experiment extends javax.swing.JFrame implements ResultListener {
	...
	TinyDBMain.simulate = false;
        ...
        try {
            TinyDBMain.initMain();
            //query = SensorQueryer.translateQuery("select nodeid, energy from sensors sample period 2048", (byte)queryid);
            query = SensorQueryer.translateQuery("select CNT(nodeid) from sensors sample period 5120", (byte)queryid);
        } catch (IOException e) {
