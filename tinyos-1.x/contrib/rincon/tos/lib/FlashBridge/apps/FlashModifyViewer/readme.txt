This is FlashBridgeViewer with the -write pointing to the
FlashModify interface.  So, it's completely compatible
with the FlashBridgeViewer java app.
...
Then use the Java FlashBridgeViewer demo app as you normally would
...
FlashBridgeViewer uses the FlashBridge interface, which is a general
