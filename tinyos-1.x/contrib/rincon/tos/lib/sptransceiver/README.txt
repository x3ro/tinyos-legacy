Update:
The newest Transceiver connects to SP to send and receive messages.
This allows existing applications that use Transceiver to continue 
to be compatible, and Transceiver also decreases the RAM consumption 
of a system by allowing resources to share actual TOS_Msg's - not just
a pool of pointers.
