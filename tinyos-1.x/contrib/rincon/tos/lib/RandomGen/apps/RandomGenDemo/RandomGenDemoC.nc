...
implementation {
  ...
  Main.StdControl -> RandomGenC;
  Main.StdControl -> LedsC;
  Main.StdControl -> TimerC;

  RandomGenDemoM.RandomGen -> RandomGenC;
  RandomGenDemoM.Leds -> LedsC;
  RandomGenDemoM.Timer -> TimerC.Timer[unique("Timer")];
}
